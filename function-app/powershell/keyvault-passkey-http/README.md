...
The Bicep sample targets a subscription you provide and defaults to `westus2`, which is available for the required resource types in the sample deployment.
