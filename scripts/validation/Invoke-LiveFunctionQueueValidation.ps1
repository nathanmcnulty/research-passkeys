...
$smokeScript = Join-Path $PSScriptRoot 'Invoke-PasskeySmokeTest.ps1'
$queueScript = Join-Path $PSScriptRoot 'Invoke-QueuePasskeyRegistration.ps1'

$powerShellRegisterUrl = "$($PowerShellBaseUrl.TrimEnd('/'))/api/passkeys/register/tap?code=$([uri]::EscapeDataString($PowerShellFunctionKey))"
$pythonRegisterUrl = "$($PythonBaseUrl.TrimEnd('/'))/api/passkeys/register/tap?code=$([uri]::EscapeDataString($PythonFunctionKey))"
$powerShellLoginUrl = "$($PowerShellBaseUrl.TrimEnd('/'))/api/passkeys/login?code=$([uri]::EscapeDataString($PowerShellFunctionKey))"
$pythonLoginUrl = "$($PythonBaseUrl.TrimEnd('/'))/api/passkeys/login?code=$([uri]::EscapeDataString($PythonFunctionKey))"
